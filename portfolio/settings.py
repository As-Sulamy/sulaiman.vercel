...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'projects.context_processors.portfolio_context',
            ],
        },
    },
]
...
#         'NAME': 'railway',
#         'USER': 'postgres',
#         'PASSWORD': 'uQtOmDyLjSfcgdzoMruWizkrBGqTJnFP',
...
CONTACT_EMAIL = 'your.email@gmail.com'  # Email where you want to receive messages
